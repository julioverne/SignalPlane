...
@interface SignalPlaneSettingsController : PSListController
{
	UILabel* _label;
	UILabel* underLabel;
}
...
@implementation SignalPlaneSettingsController
- (id)specifiers {
	if (!_specifiers) {
		...
		spec = [PSSpecifier preferenceSpecifierNamed:@"Airplane When Signal"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
											  ...
											  cell:PSLinkListCell
											        edit:Nil];
		[spec setProperty:@"Percentage" forKey:@"key"];
		[spec setProperty:@1 forKey:@"default"];
		[spec setValues:@[@0, @1, @2, @3, @4,] titles:@[@"0%", @"25% or less", @"50% or less", @"75% or less", @"100% or less",]];
        [specifiers addObject:spec];
		spec = [PSSpecifier preferenceSpecifierNamed:@"After"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
                                                  detail:PSListItemsController.class
											  cell:PSLinkListCell
											        edit:Nil];
		[spec setProperty:@"Delay" forKey:@"key"];
		[spec setProperty:@(10) forKey:@"default"];
		[spec setValues:@[@(5), @(10), @(15), @(20), @(30), @(40), @(50), @(60), @(60*2), @(60*5)] titles:@[@"5 sec", @"10 sec", @"15 sec", @"20 sec", @"30 sec", @"40 sec", @"50 sec", @"1 min", @"2 min", @"5 min"]];
        [specifiers addObject:spec];
		spec = [PSSpecifier preferenceSpecifierNamed:@"Always Enable WiFi"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
                                                  detail:Nil
											        cell:PSSwitchCell
											        edit:Nil];
		[spec setProperty:@"ForceWiFi" forKey:@"key"];
		[spec setProperty:@YES forKey:@"default"];
        [specifiers addObject:spec];
		spec = [PSSpecifier preferenceSpecifierNamed:@"Always Enable Bluetooth"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
                                                  detail:Nil
											        cell:PSSwitchCell
											        edit:Nil];
		[spec setProperty:@"ForceBT" forKey:@"key"];
		[spec setProperty:@NO forKey:@"default"];
        [specifiers addObject:spec];
		spec = [PSSpecifier preferenceSpecifierNamed:@"Vibrate Notification"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
                                                  detail:Nil
											        cell:PSSwitchCell
											        edit:Nil];
		[spec setProperty:@"Vibrate" forKey:@"key"];
		[spec setProperty:@NO forKey:@"default"];
        [specifiers addObject:spec];		
		spec = [PSSpecifier preferenceSpecifierNamed:@"Re-check After"
                                              target:self
											  set:@selector(setPreferenceValue:specifier:)
											  get:@selector(readPreferenceValue:)
                                              detail:PSListItemsController.class
											  cell:PSLinkListCell
											  edit:Nil];
		[spec setProperty:@"CheckMin" forKey:@"key"];
		[spec setProperty:@(60*5) forKey:@"default"];
		[spec setValues:@[@0, @(60), @(60*2), @(60*3), @(60*4), @(60*5), @(60*6), @(60*10), @(60*15), @(60*30), @(60*60), @(60*120), @(60*180)] titles:@[@"Disabled", @"1 min", @"2 min", @"3 min", @"4 min", @"5 min", @"6 min", @"10 min", @"15 min", @"30 min", @"1 hour", @"2 hour", @"3 hour"]];
		[specifiers addObject:spec];
        ...
        [specifiers addObject:spec];
		spec = [PSSpecifier emptyGroupSpecifier];
        [spec setProperty:@"SignalPlane © 2019" forKey:@"footerText"];
        [specifiers addObject:spec];
...
- (void)love
{
	...
	[twitter setInitialText:@"#SignalPlane by @ijulioverne is cool!"];
	if (twitter != nil) {
...
- (void)reset
{
	...
	notify_post("com.julioverne.signalplane/SettingsChanged");
...
- (void)HeaderCell
{
	@autoreleasepool {
		...
		[underLabel setText:@"Plan For Low Signal"];
